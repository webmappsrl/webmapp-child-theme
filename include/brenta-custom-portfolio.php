...
class ET_Builder_Brenta_Module_Portfolio extends ET_Builder_Module {
  function init() {
    $this->name       = esc_html__( 'Brenta Portfolio', 'et_builder' );
    $this->slug       = 'et_pb_brenta_portfolio';
...
new ET_Builder_Brenta_Module_Portfolio;

class ET_Builder_Module_POI_list extends ET_Builder_Module {
  function init() {
    $this->name       = esc_html__( 'Lista POI', 'et_builder' );
    $this->slug       = 'et_pb_poi_list';
    $this->fb_support = TRUE;
                    ...
                    <div class="meta">
                        <a href="<?php esc_url( the_permalink() ); ?>">
                          ...
                          <?php endif; ?>
                            ...
                            <p class="post-meta">
                              <?php
                              $post_terms = wp_get_post_terms( get_the_ID(), 'webmapp_category', array( "fields" => "names" ) );
                              if ( ! empty( $post_terms ) ) {
                                //$incl_cat = get_term_by('id', $atts['include_categories'], 'webmapp_category' );
